...
@SpringBootTest
@ActiveProfiles("test")
@DisplayName("FixedWindowCounter Rate Limiter Tests")
public class FixedWindowCounterRateLimiterTest {
    ...
    @BeforeEach
    void setUp() {
        rateLimiter = new FixedWindowCounterRateLimiter(redisTemplate, luaScriptExecutor, inMemoryFallback);
    ...
    void testResetsCounterAfterWindowExpires() {
